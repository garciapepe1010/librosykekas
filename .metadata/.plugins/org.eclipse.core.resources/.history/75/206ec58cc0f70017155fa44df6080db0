                                ...
                                <div class="col-md-6">
                                    ...
                                    <form role="form"  method="post" action="AcercaDeWebPage" >
                                    	...
                                    	<div class="form-group" id="presentation">
                                            ...
                                            <textarea class="form-control" name="acercade" rows="3">${acercade}</textarea>
                                        </div>
                                        <div class="form-group" id="presentation">
                                            <label>Aun m&aacute;s</label>
                                            <textarea class="form-control" name="aunmas" rows="3">${aunmas}</textarea>
                                        </div>
                                        <div class="form-group" id="presentation">
                                            <label>Historia</label>
                                            <textarea class="form-control" name="historia" rows="3">${historia}</textarea>
                                        </div>
                                        <div class="form-group" id="presentation">
                                            <label>Inquietudes</label>
                                            <textarea class="form-control" name="inquietudes" rows="3">${inquietudes}</textarea>
                                        </div>
                                        <div class="form-group" id="presentation">
                                            <label>Kekas</label>
                                            <textarea class="form-control" name="kekas" rows="3">${kekas}</textarea>
                                        </div>
                                        <div class="form-group" id="presentation">
                                            <label>Libros</label>
                                            <textarea class="form-control" name="libros" rows="3">${libros}</textarea>
                                        </div>
                                        <div class="form-group" id="presentation">
                                            <label>Viajes</label>
                                            <textarea class="form-control" name="viajes" rows="3">${viajes}</textarea>
                                        </div>
