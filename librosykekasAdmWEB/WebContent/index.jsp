...
<head>
    ...
    <link href="${prm.HOST_STATIC_FILES}/assets/css/font-awesome.css" rel="stylesheet" />
     <!-- MORRIS CHART STYLES-->
    <link href="${prm.HOST_STATIC_FILES}/assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="LogOut" class="btn btn-danger square-btn-adjust">Logout</a> </div>
    ...
    <script src="${prm.HOST_STATIC_FILES}/assets/js/jquery.metisMenu.js"></script>
     ...
     <script src="${prm.HOST_STATIC_FILES}/assets/js/morris/raphael-2.1.0.min.js"></script>
    <script src="${prm.HOST_STATIC_FILES}/assets/js/morris/morris.js"></script>
      <!-- CUSTOM SCRIPTS -->
