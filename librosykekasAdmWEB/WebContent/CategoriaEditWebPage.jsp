           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  class="active-menu"  href="CategoriaWebPage"><i class="fa fa-desktop fa-3x"></i>Mant. Categorias.</a>
                    </li>
                    <li>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Categor&iacute;s
						         ...
						         <c:if test = "${CategoriaAccion == 'E'}">
						            (Edici&oacute;n)
						         </c:if>
						         
						         <c:if test = "${CategoriaAccion == 'A'}">
						           (A&ntilde;adir)
						         </c:if>
						         
						         <c:if test = "${CategoriaAccion == 'D'}">
						           (Duplicar)
						         </c:if>
						         
						         <c:if test = "${CategoriaAccion == 'X'}">
						           (Eliminar)
						         </c:if>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form role="form"  method="post" action="CategoriaWebPage" >
                                    	<div class="form-group" id="presentation">
                                            <label>C&oacute;digo</label>
                                            <label>${Categoria.clave}</label>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Nombre</label>
									         	...
									         	<c:if  test = "${CategoriaAccion == 'E'}">
													<input class="form-control" name="nombre" value="${Categoria.nombre}"/>
									         	</c:if>
									         	<c:if  test = "${CategoriaAccion == 'D'}">
													<input class="form-control" name="nombre" value="${Categoria.nombre}" editable=false/>
									         	</c:if>
									         	<c:if  test = "${CategoriaAccion == 'X'}">
													<input class="form-control" name="nombre" value="${Categoria.nombre}" editable=false/>
									         	</c:if>

                                            <p class="help-block">Nombre de la categor&iacute;a</p>
                                        </div>
                                        
                                          
								         <c:if  test = "${CategoriaAccion == 'E'}">
								            <input type="hidden" name="clave" value="${Categoria.clave}">
