                                    ...
                                    <form role="form"  method="post" action="ItemWebPage" >
                                        ...
                                        <div class="form-group">
                                            <label>T&iacute;tulo</label>
									         	...
									         	<c:if  test = "${ItemAccion == 'E'}">
													<input class="form-control" name="titulo" value="${Item.titulo}"/>
									         	</c:if>
									         	<c:if  test = "${ItemAccion == 'D'}">
													<input class="form-control" name="titulo" value="${Item.titulo}" editable=false/>
									         	</c:if>
									         	<c:if  test = "${ItemAccion == 'X'}">
													<input class="form-control" name="titulo" value="${Item.titulo}" editable=false/>
									         	</c:if>

                                            <p class="help-block">T&icaute;tulo del item</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Rese&ntilde;a</label>
									         	...
									         	<c:if  test = "${ItemAccion == 'A'}">
													<input class="form-control" name="resena"/>
									         	</c:if>
									         	<c:if  test = "${ItemAccion == 'E'}">
													<input class="form-control" name="resena" value="${Item.resena}"/>
									         	</c:if>
									         	<c:if  test = "${ItemAccion == 'D'}">
													<input class="form-control" name="resena" value="${Item.resena}" editable=false/>
									         	</c:if>
									         	<c:if  test = "${ItemAccion == 'X'}">
													<input class="form-control" name="resena" value="${Item.resena}" editable=false/>
									         	</c:if>
                                        ...
                                        <div class="form-group">
                                            <label>Comentario</label>
									         	...
									         	<c:if  test = "${ItemAccion == 'E'}">
													<input class="form-control" name="comentario" value="${Item.comentario}"/>
									         	</c:if>
									         	<c:if  test = "${ItemAccion == 'D'}">
													<input class="form-control" name="comentario" value="${Item.comentario}" editable=false/>
									         	</c:if>
									         	<c:if  test = "${ItemAccion == 'X'}">
													<input class="form-control" name="comentario" value="${Item.comentario}" editable=false/>
									         	</c:if>
